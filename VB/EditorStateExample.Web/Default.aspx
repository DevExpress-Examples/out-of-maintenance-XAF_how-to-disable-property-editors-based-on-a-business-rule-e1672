...
<%@ Register Assembly="DevExpress.Web.v11.2" Namespace="DevExpress.Web.ASPxRoundPanel"
    TagPrefix="dxrp" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v11.2" Namespace="DevExpress.Web.ASPxEditors"
    TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.v11.2" Namespace="DevExpress.Web.ASPxPanel"
    TagPrefix="dxrp" %>
<%@ Register Assembly="DevExpress.Web.v11.2" Namespace="DevExpress.Web.ASPxSplitter"
    TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.v11.2" Namespace="DevExpress.Web.ASPxGlobalEvents"
    TagPrefix="dxge" %>
...
<body class="HorizontalTemplate BodyBackColor" onload="OnLoad()">
    ...
    <div runat="server">
                        ...
                        <table id="MRC" style="width: 100%" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td id="separatorCell" style="width: 6px; border-bottom-style: none; border-top-style: none;
                                    display: none" class="dxsplVSeparator_<%=Theme%> dxsplPane_<%=Theme%>">
     ...
     <!--
            function OnLoad() {
                Init("<%=Theme%>", "DefaultCS");
                OnLoadCore("LPcell", "separatorCell", "separatorImage", eval(<%=If((VTC.HasActiveActions() OrElse DAC.HasActiveActions()), "true", "false")%>), true);
            }
         // -->
        </script>
    </div>
