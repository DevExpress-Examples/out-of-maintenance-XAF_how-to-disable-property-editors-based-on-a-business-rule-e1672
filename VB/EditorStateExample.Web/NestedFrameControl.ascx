<%@ Control Language="vb" AutoEventWireup="true" EnableViewState="false" Inherits="NestedFrameControl"
    CodeBehind="NestedFrameControl.ascx.vb" %>
...
<div class="NestedFrame">
    <cc3:XafUpdatePanel ID="UPToolBar" CssClass="ToolBarUpdatePanel" runat="server">
        <cc2:ActionContainerHolder runat="server" ID="ToolBar" CssClass="ToolBar" ContainerStyle="ToolBar"
            ImageTextStyle="CaptionAndImage" Orientation="Horizontal" Categories="ObjectsCreation;Link;Edit;RecordEdit;View;Reports;Diagnostic;Filters"
