...
Namespace EditorStateExample.Web
    Partial Public Class EditorStateExampleAspNetApplication
        ...
        Private Sub EditorStateExampleAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
            e.Updater.Update()
            e.Handled = True
        End Sub
