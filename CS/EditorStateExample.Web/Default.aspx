...
<body onload="OnLoad()">
    ...
    <cc2:NavigationTabsActionContainer ID="NavigationTabsActionContainer" runat="server" ContainerId="ViewsNavigation" />
                    ...
                    <dxrp:ASPxRoundPanel ID="ToolsRoundPanel" runat="server" Width="100%" HeaderText="Tools">
                     <PanelCollection>
                         <dxrp:PanelContent ID="PanelContent1" runat="server">
                               <cc2:WebActionContainer id="VerticalToolsActionContainer" runat="server" Orientation="Vertical" CssClass="VContainer" ContainerId="Tools" BorderWidth="0px" ContainerStyle="Links"></cc2:WebActionContainer>
                         </dxrp:PanelContent>
                     </PanelCollection>
                    </dxrp:ASPxRoundPanel>
                </td>
		...
		<td><cc2:WebActionContainer ID="DiagnosticActionContainer" Wrapped="True" Orientation="Horizontal" runat="server"
